...
class TestNetworkResilience:
    ...
    def test_successful_response_with_network_conditions(self, message_content, language):
        """
    ...
    def test_graceful_error_handling(self, message_content, error_type):
        """
    ...
    def test_model_fallback_resilience(self, message_content):
        """
