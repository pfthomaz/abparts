    ...
    <div className="min-h-screen bg-gray-100">
      ...
      {!showChatWidget && user?.username === 'dthomaz' && (
        <button
          ...
          className="fixed bottom-4 left-4 z-40 bg-blue-600 hover:bg-blue-700 text-white p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
