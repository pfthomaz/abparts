#!/usr/bin/env python3
"""
Core Machine Endpoints Frontend Integration Test

This test validates the core machine endpoints that should be working:
- Machine list
- Machine details  
- Machine usage history
- Machine compatible parts

This focuses on the endpoints that are essential for frontend integration.
"""
...
class CoreMachineEndpointTester:
    """Test class for validating core machine endpoints from frontend perspective."""
    ...
    def run_core_tests(self) -> Dict[str, Any]:
        """Run core machine endpoint tests and return comprehensive results."""
        logger.info("Starting core machine endpoint validation...")
...
def main():
    """Main function to run the core machine endpoint validation."""
    print("=" * 60)
    print("Core Machine API Endpoints Frontend Integration Test")
    print("=" * 60)
    ...
    # Run the tests
    tester = CoreMachineEndpointTester()
    ...
    if results["overall_success"]:
        print("🎉 All core machine endpoints are working correctly from frontend perspective!")
        return True
    else:
        print("❌ Some core machine endpoints have issues that need to be addressed.")
        return False
